...
import cn.softeng.input.InputErrorException;
import cn.softeng.input.Keyword;
import cn.softeng.input.Output;
import cn.softeng.input.StringInput;
import cn.softeng.states.StateEntity;
//import cn.softeng.units.DimensionlessUnit;
//import cn.softeng.units.RateUnit;
//import cn.softeng.units.TimeUnit;
...
public abstract class LinkedComponent extends StateEntity {
	...
	private Entity receivedEntity; // Entity most recently received by this component
	private double releaseTime = Double.NaN;

	{
		attributeDefinitionList.setHidden(false);

		defaultEntity = new EntityInput<>(Entity.class, "DefaultEntity", "Key Inputs", null);
	...
	protected void setReceivedEntity(Entity ent) {
		receivedEntity = ent;
	}
	 ...
	 */
	public void sendToNextComponent(Entity ent) {
		numberProcessed++;
	...
	@Output(name = "obj",
	 description = "The entity that was received most recently.",
	    sequence = 0)
	public Entity getReceivedEntity(double simTime) {
