...
import cn.softeng.Samples.SampleInput;
//import cn.softeng.Thresholds.Threshold;
//import cn.softeng.Thresholds.ThresholdUser;
import cn.softeng.basicsim.Entity;
import cn.softeng.basicsim.EntityTarget;
import cn.softeng.basicsim.Simulation;
...
import cn.softeng.input.EntityListInput;
import cn.softeng.input.Keyword;
import cn.softeng.input.Output;
//import cn.softeng.input.Vec3dInput;
//import cn.softeng.math.Vec3d;
import cn.softeng.states.DowntimeUser;
//import cn.softeng.units.DimensionlessUnit;
//import cn.softeng.units.DistanceUnit;

public abstract class LinkedService extends LinkedComponent implements QueueUser {
...
//		this.addInput(opportunisticBreakdownList);
	 ...
	 */
	protected Entity getNextEntityForMatch(Integer m) {
		Entity ent = waitQueue.getValue().removeFirstForMatch(m);
